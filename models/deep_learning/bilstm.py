...
class BiLSTMRegressor(DLRegressor):
    ...
    def build_model(self, input_shape):
        ...
        if is_spline:
            ...
            x = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(20, return_sequences=True, 
        ...
        x = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(16, return_sequences=True, 

...
class GRURegressor(DLRegressor):
    ...
    def build_model(self, input_shape):
        ...
        # Self-Attention Layer (after GRU layers)
        attention_output = tf.keras.layers.MultiHeadAttention(num_heads=4, key_dim=16)(gru_layer2, gru_layer2)
        attention_output = tf.keras.layers.LayerNormalization()(attention_output + gru_layer2)  # Add & Norm

...
class ConvGRURegressor(DLRegressor):
    """
    This is a class implementing the ConvGRU model for time series regression.
    ...
    def build_model(self, input_shape):
        ...
        gru_layer1 = tf.keras.layers.GRU(8, return_sequences=True, 
        ...
        gru_layer2 = tf.keras.layers.GRU(4, return_sequences=False, 
                                           kernel_regularizer=tf.keras.regularizers.L1L2(l1=0, l2=2e-6),  
                                           recurrent_regularizer=tf.keras.regularizers.L1L2(l1=2e-6, l2=0),
                                           activation='tanh')(gru_layer1)

        gru_layer2 = tf.keras.layers.Dropout(rate=0.1)(gru_layer2)
